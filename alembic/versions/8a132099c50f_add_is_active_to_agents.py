...
def upgrade() -> None:
    ...
    op.add_column('agents', sa.Column('is_active', sa.Boolean(), nullable=True, server_default='t'))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('chat_sessions', sa.Column('agent_id', sa.UUID(), autoincrement=False, nullable=True))
    op.create_foreign_key('chat_sessions_agent_id_fkey', 'chat_sessions', 'agents', ['agent_id'], ['id'])
    op.alter_column('agents', 'system_prompt',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('agents', 'temperature',
