...
class LLMClient:
    ...
    async def _call_llm_api(self, model: str, messages: List[Dict[str, str]], temperature: float, max_tokens: int) -> str:
    ...
    async def generate_chat_response(
        ...
        try:
            ...
            logger.debug(f"Sending messages to LLM: {json.dumps(messages_preview, ensure_ascii=False, indent=2)}")
        except Exception as e:
